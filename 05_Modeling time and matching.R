...
indivyear[,X := factor(paste(generation,broadbackground,sep=': '),
                       levels=c('Native: Finland',
                                '1.5G+2G migrant: Northwest Europe','2.5G migrant: Northwest Europe',
                                '1.5G+2G migrant: South & East Europe','2.5G migrant: South & East Europe',
                                '1.5G+2G migrant: Former USSR','2.5G migrant: Former USSR',
                                '1.5G+2G migrant: Middle East & North Africa','2.5G migrant: Middle East & North Africa',
                                '1.5G+2G migrant: Sub-Saharan Africa','2.5G migrant: Sub-Saharan Africa',
                                '1.5G+2G migrant: South & Southeast Asia','2.5G migrant: South & Southeast Asia',
                                '1.5G+2G migrant: East Asia, Americas & Pacific','2.5G migrant: East Asia, Americas & Pacific'))]
indivyear[,summary(X)]
...
# Save image
save(indivyear,file="cem.sample.women.RData")

########################################################################################################################

# Let' see the estimated hazard and survival probabilities after matching
...
hazarddata <- data.table(
  ...
  broadbackground = c(rep(indivyear[,levels(broadbackground)[-1]],each=25,times=3)),
